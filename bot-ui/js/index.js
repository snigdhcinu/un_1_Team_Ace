...
$(window).load(function() {
  ...
  setTimeout(function() {
    serverMessage("Hey there, type 'hi' to begin our conversation. ");
  }, 100);
...
function fetchmsg(){
     ...
     var url = 'http://localhost:3000/send-msg';
      ...
      for (const pair of new FormData(document.getElementById("mymsg"))) {
          ...
          // console.log(pair) // Console.log our req,res pair from bot.
      }
      ...
      console.log("abc",data)
        fetch(url, {
         ...
         .then(response => {
          ...
          if(response.Reply.auth == 'success'){
            serverMessage(response.Reply.callback);
            setTimeout(function(){ serverMessage("You were successfully authenticated, state your query ."); }, 1000);
